...
# -*- coding: utf-8 -*-
"""
Enhanced NumberBox Decryptor - استخدام المفاتيح المستخرجة من Context
"""
...
def test_all_keys():
    ...
    print("🔥 Enhanced NumberBox Decryptor")
    print("=" * 50)
    ...
    for data, data_name in datasets:
        ...
        for i, key in enumerate(EXTRACTED_KEYS):
            ...
            if test_key_on_data(key, data, data_name, key_name):
                success_count += 1
                print(" ✅")
                break
            else:
...
def analyze_encryption_differences():
    ...
    if (OLD_ENCRYPTED_CCODE != "PLACEHOLDER_OLD_CCODE" and 
        ...
        old_len = len(base64.b64decode(OLD_ENCRYPTED_CCODE))
        new_len = len(base64.b64decode(NEW_ENCRYPTED_CCODE))
